// ==UserScript==
// @name         Open Source Client
// @version      1.0
// @description  Open Source Client for Starblast.IO
// @author       You, not me
// @license      GPL-3.0
...
document.open();
document.write(
    `<html><head><title>Loading...</title></head><body style="background-color:#293449;"><div style="margin: auto; width: 50%;"><h1 style="text-align: center;padding: 170px 0;font-family:Play,Verdana;">Loading Open Source Client</h1><h1 style="text-align: center;font-family:Play,Verdana;">Please wait</h1></div></body></html>`
);
document.close();
log(`Started`);
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4) {
            ...
            ClientCode = ClientCode.replace(
                ...
                , "https://imgs.search.brave.com/n2N7h521IfESuWZ-iyJt7r2oCytzzoaCKrNWqIuq7Hg/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9jbGlw/YXJ0LWxpYnJhcnku/Y29tL25ld19nYWxs/ZXJ5LzUyLTUyNjI3/M19uZXJkeS1nbGFz/c2VzLXBuZy5wbmc"
            );
