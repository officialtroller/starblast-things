var gameInfo = {
    ...
    commandsInfo: {
        ...
        log: function (name, ID, color, end) {
            ...
            game.modding.terminal.echo(`!bot Player: ${name} ID: ${ID} ${end || 'undefined'}`);
        },
        more: {
            usage: 'more',
        ...
        info: {
            ...
            action: function () {
                ...
                const bannedPlayerList = Object.keys(gameOptions.ban)
                    .map(index => {
                        return `[[g;#ff7070;]Index:] [[g;Gold;]${index}][[g;#ff7070;], Name:] [[g;Gold;]${gameOptions.ban[index].name}]\n[[g;#ff7070;]Reason:] [[g;Gold;]${gameOptions.ban[index].reason}]`;
                    })
                    .join('\n');
        ...
        idle: {
            ...
            action: function (ID, duration = 20, showMessage = true) {
                ...
                if (duration < 1e9) {
                    ship.custom.idleTM = setTimeout(function () {
        ...
        admin: {
            ...
            action: function (ID, which) {
                ...
                if (!gameOptions.adminShip.includes(ship.type.toString()) || which) {
                    ...
                    switch (which || 'p') {
                        case 'p':
                            new_type = gameOptions.adminShip[0];
                            break;
                        case 'g':
                            new_type = gameOptions.adminShip[1];
                            break;
                    }
...
function Auth(t) {
    ...
    let o = '';
    for (; o.length < t; ) {
        const t = Math.floor(36 * Math.random()),
            r = n.charAt(t);
        o.includes(r) || (o += r);
    }
    return o;
